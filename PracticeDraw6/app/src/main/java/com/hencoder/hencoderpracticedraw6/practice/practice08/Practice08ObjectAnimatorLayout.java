    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                objectAnimator = ObjectAnimator.ofFloat(view,"progress",0,65).setDuration(800);
                objectAnimator.setInterpolator(new OvershootInterpolator());//FastOutSlowInInterpolator
