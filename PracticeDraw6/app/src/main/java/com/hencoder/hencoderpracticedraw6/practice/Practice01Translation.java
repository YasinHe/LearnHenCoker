            ...
            public void onClick(final View v) {
                ...
                switch (action){
                    case 1:
                        ...
                        break;
                    case 2:
                        imageView.animate().translationXBy(-500);//translationX(0)
                        ++action;
                        break;
                    case 3:
                        ...
                        break;
                    case 4:
                        imageView.animate().translationYBy(-100);//0
                        ++action;
                        break;
                    case 5:
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            imageView.animate().translationZ(80);
                        }
                        ++action;
                        break;
                    case 6:
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            imageView.animate().translationZBy(-80);//0
                        }
                        action = 1;
                        break;
                }
