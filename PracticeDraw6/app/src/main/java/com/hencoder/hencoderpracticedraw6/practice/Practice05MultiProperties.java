    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (action){
                    case 1:
                        imageView.animate().scaleX(1).scaleY(1).alpha(1).rotation(360).translationX(600);
                        ++action;
                        break;
                    case 2:
                        imageView.animate().scaleXBy(-1).scaleYBy(-1).alpha(0).rotationBy(-360).translationXBy(-600);
